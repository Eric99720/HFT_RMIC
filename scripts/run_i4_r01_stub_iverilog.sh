...
iverilog -g2012 -DHFT_RMIC_BEHAVIORAL_RAM -I "$ROOT/rtl/include" \
  -o "$BUILD/i4_r01_stub_tb.vvp" \
  "$ROOT/tb/stubs/amu_banked_double_hash_v2_stub.sv" \
  "$ROOT/tb/stubs/financial_protocol_encoder_stub.sv" \
  ...
  "$ROOT/rtl/integration/hft_rmic_shared_core_v1.sv" \
  "$ROOT/rtl/integration/hft_rmic_dual_order_source_v1.sv" \
  "$ROOT/rtl/integration/hft_rmic_r01_path_v1.sv" \
  "$ROOT/tb/tb_hft_rmic_r01_path_stub_v1.sv"
vvp "$BUILD/i4_r01_stub_tb.vvp"
