...
`define HFT_RMIC_SYSTEM_REASON_ORDER_CONTEXT_EXISTS       8'd10
`define HFT_RMIC_SYSTEM_REASON_ORDER_CONTEXT_FULL         8'd11
`define HFT_RMIC_SYSTEM_REASON_ADMISSION_ROLLBACK_FAILED  8'd12
